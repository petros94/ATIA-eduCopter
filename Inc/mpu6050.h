...
typedef struct  {
	...
	float Accelerometer_X_conv;
	float Accelerometer_Y_conv;
	float Accelerometer_Z_conv;
	float Gyroscope_X_conv;
	float Gyroscope_Y_conv;
	float Gyroscope_Z_conv;

	float rpy[3];
	float rpy_filtered[3];
